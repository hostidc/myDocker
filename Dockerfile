...
# 安装 Redis 便携版（linux amd64，无需编译，直接运行）
...
# ============================================
# 启动命令：Redis + MinIO 后台运行 + 前台 Jupyter
# ============================================
CMD sh -c "
# 启动 Redis
# redis-server --bind 0.0.0.0 --port ${REDIS_PORT} --requirepass \"${REDIS_PASSWORD}\" --dir ${REDIS_DIR} &
# sleep 1
...
# echo '✅ MinIO 已启动'
# echo '🔑 MinIO 用户: '${MINIO_ROOT_USER}
# echo '🔑 MinIO 密码: '${MINIO_ROOT_PASSWORD}
# echo '🖥 MinIO 控制台: /proxy/9001'
# echo '==================================================='
